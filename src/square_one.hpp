...
{
// Code sourced from
// <https://github.com/thewca/tnoodle-lib/blob/master/scrambles/src/main/java/org/worldcubeassociation/tnoodle/puzzle/SquareOnePuzzle.java>
// It is also under the GNU General Public License v3.0
// <https://github.com/thewca/tnoodle-lib/blob/master/LICENSE>
...
{
	std::string scramble;
	std::vector<int> pieces{ 0, 0, 1, 2,  2,  3,  4,  4,  5,  6,  6,  7,
